  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        child: Column(
          children: [
            Avatar('https://cdn.pixabay.com/photo/2016/11/14/04/36/boy-1822614_640.jpg'),
            SizedBox(height: 20),
      ...
      children: [
        Expanded(
          child: Container(
            child: Column(
              children: [
                text(lable: dangFollow.toString(), size: 20, fontWeight: FontWeight.w900),
                SizedBox(height: 5),
                text(lable: "Đang follow", size: 15, fontWeight: FontWeight.normal),
              ],
            ),
          ),
        ),Expanded(
          child: Container(
            child: Column(
              children: [
                text(lable: follow.toString(), size: 20, fontWeight: FontWeight.w900),
                SizedBox(height: 5),
                text(lable: "Follower", size: 15, fontWeight: FontWeight.normal),
              ],
            ),
          ),
        ),Expanded(
          child: Container(
            child: Column(
              children: [
                text(lable: like.toString(), size: 20, fontWeight: FontWeight.w900),
                SizedBox(height: 5),
        ...
        OutlinedButton(
            style: ButtonStyle(
              ...
              minimumSize: MaterialStateProperty.all<Size>(
                Size(100, 40), // Đặt kích thước theo chiều rộng và chiều cao mong muốn
              ),
            ),
            onPressed: (){
              Navigator.push(
                ...
                PageRouteBuilder(
                  ...
                  transitionsBuilder:
                    ...
                    const begin = Offset(0.0, 1.0); // Điểm bắt đầu (nếu bạn muốn chuyển từ bên phải)
                    const end = Offset
              ...
              Positioned(
                top: 0,
                  ...
                  child: TabBar(
                    ...
                    tabs: [
                      Tab(child: Icon(Icons.video_collection,color: Colors.black,)),
